...
enum RaceType_t { RACE_NONE = 0, RACE_VENOM = 1, RACE_BLOOD = 2, RACE_UNDEAD = 3, RACE_FIRE = 4 };
...
enum BlockType_t { BLOCK_NONE = 0, BLOCK_DEFENSE, BLOCK_ARMOR, BLOCK_IMMUNITY };
...
enum PlayerSex_t { PLAYERSEX_FEMALE = 0, PLAYERSEX_MALE = 1, PLAYERSEX_OLDMALE = 2 };
