...
ProtocolOld::ProtocolOld(Connection_ptr connection) : Protocol(connection)
{
	enableChecksum();
...
ProtocolOldLogin::ProtocolOldLogin(Connection_ptr connection) : ProtocolOld(connection)
{
}
...
ProtocolOldGame::ProtocolOldGame(Connection_ptr connection) : ProtocolOld(connection)
{
}
