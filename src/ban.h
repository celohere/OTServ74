...
public:
	...
	bool addPlayerBan(uint32_t playerId,
	                  int32_t time,
	                  uint32_t adminid,
	                  std::string comment,
	                  std::string statement,
	...
	bool addPlayerBan(const std::string &name,
	                  int32_t time,
	                  uint32_t adminid,
	                  std::string comment,
	                  std::string statement,
	                  uint32_t reason,
	                  ViolationAction action) const;
	bool addPlayerStatement(uint32_t playerId,
	                        uint32_t adminid,
	                        std::string comment,
	                        std::string statement,
	                        uint32_t reason,
	                        ViolationAction action) const;
	bool addAccountBan(uint32_t account,
	                   int32_t time,
	                   uint32_t adminid,
	                   std::string comment,
	                   std::string statement,
	                   uint32_t reason,
	                   ViolationAction action) const;
	bool addAccountNotation(uint32_t account,
	                        uint32_t adminid,
	                        std::string comment,
	                        std::string statement,
	                        uint32_t reason,
