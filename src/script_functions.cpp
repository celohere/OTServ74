...
const luaL_Reg lua_BitReg[] = { { "bnot", lua_BitNot },
	                        { "band", lua_BitAnd },
	                        { "bor", lua_BitOr },
	                        { "bxor", lua_BitXor },
...
void Manager::registerClasses()
{
	...
	registerMemberFunction("Condition", "setMechanicType(MechanicType type)",
	                       &Manager::lua_Condition_setMechanicType);
	...
	registerMemberFunction("Condition",
	                       "addPeriodicHeal(int interval, int min, int max, int rounds)",
	                       &Manager::lua_Condition_addPeriodicHeal);
	registerMemberFunction("Condition", "addPeriodicDamage(int interval, "
	                                    "CombatType type, int min, int max, int "
	                                    "rounds)",
	                       &Manager::lua_Condition_addPeriodicDamage);
	registerMemberFunction("Condition", "addAveragePeriodicDamage(int interval, "
	                                    "CombatType type, int min, int max, int "
	                                    "first)",
	                       &Manager::lua_Condition_addAveragePeriodicDamage);
	registerMemberFunction("Condition", "addModStamina(int interval, int value)",
	                       &Manager::lua_Condition_addModStamina);
	registerMemberFunction("Condition", "addRegenHealth(int interval, int value)",
	                       &Manager::lua_Condition_addRegenHealth);
	registerMemberFunction("Condition", "addRegenPercentHealth(int interval, PlayerStatType "
	                                    "type, int percent)",
	                       &Manager::lua_Condition_addRegenPercentHealth);
	registerMemberFunction("Condition", "addRegenMana(int interval, int value)",
	                       &Manager::lua_Condition_addRegenMana);
	registerMemberFunction("Condition", "addRegenPercentMana(int interval, PlayerStatType "
	                                    "type, int percent)",
	                       &Manager::lua_Condition_addRegenPercentMana);
	registerMemberFunction("Condition", "addRegenSoul(int interval, int value)",
	                       &Manager::lua_Condition_addRegenSoul);
	registerMemberFunction("Condition", "addRegenPercentSoul(int interval, PlayerStatType "
	                                    "type, int percent)",
	                       &Manager::lua_Condition_addRegenPercentSoul);
	registerMemberFunction("Condition", "addModSpeed(int percent, int value)",
	                       &Manager::lua_Condition_addModSpeed);
	registerMemberFunction("Condition", "addModStat(PlayerStatType type, int value)",
	                       &Manager::lua_Condition_addModStat);
	registerMemberFunction("Condition", "addModPercentStat(PlayerStatType type, int percent)",
	                       &Manager::lua_Condition_addModPercentStat);
	registerMemberFunction("Condition", "addModSkill(SkillType type, int value)",
	                       &Manager::lua_Condition_addModSkill);
	registerMemberFunction("Condition", "addModPercentSkill(SkillType type, int percent)",
	                       &Manager::lua_Condition_addModPercentSkill);
	...
	registerMemberFunction("Condition", "addScript(string name [, int interval = nil])",
	                       &Manager::lua_Condition_addScript);
	...
	registerMemberFunction("Vocation", "getMeleeBaseDamage(WeaponType weaponType)",
	                       &Manager::lua_Vocation_getMeleeBaseDamage);
	...
	// Creature
	registerMemberFunction("Creature", "setRawCustomValue(string key, mixed value)",
	                       &Manager::lua_Creature_setRawCustomValue);
	...
	registerMemberFunction("Creature", "isImmuneToCombat(CombatType combattype)",
	                       &Manager::lua_Creature_isImmuneToCombat);
	registerMemberFunction("Creature", "isImmuneToMechanic(MechanicType conditiontype)",
	                       &Manager::lua_Creature_isImmuneToMechanic);
	...
	registerMemberFunction("Creature", "internalAddCondition(Condition condition)",
	                       &Manager::lua_Creature_internalAddCondition);
    ...
    [, boolean showEffect [, MagicEffect hitEffect [, TextColor hitTextColor]]]]])",
	                       &Manager::lua_internalCastSpell);
	...
	registerMemberFunction("Actor", "setCanPushCreatures(boolean canpushcreatures)",
	                       &Manager::lua_Actor_setCanPushCreatures);
	...
	registerMemberFunction("Actor", "setTargetDistance(int newtargetdistance)",
	                       &Manager::lua_Actor_setTargetDistance);
	...
	registerMemberFunction("Actor", "setStaticAttackChance(int chance)",
	                       &Manager::lua_Actor_setStaticAttackChance);
	...
	registerMemberFunction("Actor", "setCanBeAttacked(boolean isAttackable)",
	                       &Manager::lua_Actor_setCanBeAttacked);
	...
	registerMemberFunction("Actor", "setMechanicImmunities(table immunities)",
	                       &Manager::lua_Actor_setMechanicImmunities);
	registerMemberFunction("Actor", "setDamageImmunities(table immunities)",
	                       &Manager::lua_Actor_setDamageImmunities);
	...
	registerMemberFunction("Player", "advanceSkill(SkillType skill, int count)",
	                       &Manager::lua_Player_advanceSkill);
	...
	registerMemberFunction("Player", "addItem(Item item [, SlotType slot = nil "
	                                 "[, boolean canDropOnMap = nil]])",
	                       &Manager::lua_Player_addItem);
	registerMemberFunction("Player", "removeItem(int id [, int type [,int count]])",
	                       &Manager::lua_Player_removeItem);
	...
	registerMemberFunction("Player", "getDepot(int id [, boolean autoCreate = nil])",
	                       &Manager::lua_Player_getDepot);
	...
	registerMemberFunction("Player", "sendMessage(MessageClass type, mixed msg)",
	                       &Manager::lua_Player_sendMessage);
	...
	registerMemberFunction("Item", "setStringAttribute(string key, string value)",
	                       &Manager::lua_Item_setStringAttribute);
	registerMemberFunction("Item", "setIntegerAttribute(string key, int value)",
	                       &Manager::lua_Item_setIntegerAttribute);
	registerMemberFunction("Item", "setFloatAttribute(string key, float value)",
	                       &Manager::lua_Item_setFloatAttribute);
	registerMemberFunction("Item", "setBooleanAttribute(string key, boolean value)",
	                       &Manager::lua_Item_setBooleanAttribute);
	...
	registerMemberFunction("Channel", "talk(Player speaker, SpeakClass type, string msg)",
	                       &Manager::lua_Channel_talk);
}
...
void Manager::registerFunctions()
{
	...
	// OnSay/OnHear
	registerGlobalFunction("registerOnSay(string method, boolean case_sensitive, "
	                       "string filter, function callback)",
	                       &Manager::lua_registerGenericEvent_OnSay);
	registerGlobalFunction("registerOnCreatureSay(Creature who, string method, "
	                       "boolean case_sensitive, string filter, function "
	                       "callback)",
	                       &Manager::lua_registerSpecificEvent_OnSay);
	registerGlobalFunction("registerOnHear(Creature who, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnHear);

	// OnUse
	registerGlobalFunction("registerOnUseItem(string method, int filter, function callback)",
	                       &Manager::lua_registerGenericEvent_OnUseItem);

	// OnUseWeapon
	registerGlobalFunction("registerOnUseWeapon([int weaponid = nil], string "
	                       "method, function callback)",
	                       &Manager::lua_registerGenericEvent_OnUseWeapon);

	// OnMove
	registerGlobalFunction("registerOnCreatureMove(Creature who, function callback)",
	                       &Manager::lua_registerSpecificEvent_CreatureMove);
	registerGlobalFunction("registerOnCreatureMoveIn(Creature who, string "
	                       "method, int itemid, function callback)",
	                       &Manager::lua_registerSpecificEvent_CreatureMoveIn);
	registerGlobalFunction("registerOnCreatureMoveOut(Creature who, string "
	                       "method, int itemid, function callback)",
	                       &Manager::lua_registerSpecificEvent_CreatureMoveOut);
	registerGlobalFunction("registerOnAnyCreatureMoveIn(string method, int "
	                       "itemid, function callback)",
	                       &Manager::lua_registerGenericEvent_CreatureMoveIn);
	registerGlobalFunction("registerOnAnyCreatureMoveOut(string method, int "
	                       "itemid, function callback)",
	                       &Manager::lua_registerGenericEvent_CreatureMoveOut);

	// OnTurn
	registerGlobalFunction("registerOnAnyCreatureTurn(function callback)",
	                       &Manager::lua_registerGenericEvent_OnCreatureTurn);
	registerGlobalFunction("registerOnCreatureTurn(Creature who, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnCreatureTurn);

	// On(De)Equip
	registerGlobalFunction("registerOnEquipItem([string when = nil], string "
	                       "method, int filter, SlotPosition slot, function "
	                       "callback)",
	                       &Manager::lua_registerGenericEvent_OnEquipItem);
	registerGlobalFunction("registerOnDeEquipItem([string when = nil], string "
	                       "method, int filter, SlotPosition slot, function "
	                       "callback)",
	                       &Manager::lua_registerGenericEvent_OnDeEquipItem);

	// OnServerLoad
	registerGlobalFunction("registerOnServerLoad(function callback)",
	                       &Manager::lua_registerGenericEvent_OnServerLoad);

	// OnMoveItem
	// Registering other OnMoveItem events are done through lua
	registerGlobalFunction("registerOnMoveItem([string when = nil], string "
	                       "method, int filter, boolean isadd, boolean isontile, "
	                       "function callback)",
	                       &Manager::lua_registerGenericEvent_OnMoveItem);

	// OnSpot / OnLose
	registerGlobalFunction("registerOnSpotCreature(Creature creature, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnSpotCreature);
	registerGlobalFunction("registerOnLoseCreature(Creature creature, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnLoseCreature);

	// OnThink
	registerGlobalFunction("registerOnCreatureThink(Creature creature, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnCreatureThink);

	// OnSpawn
	registerGlobalFunction("registerOnSpawn(string cname, function callback)",
	                       &Manager::lua_registerGenericEvent_OnSpawn);

	// OnJoin / OnLeave (channel)
	registerGlobalFunction("registerOnJoinChannel(function callback)",
	                       &Manager::lua_registerGenericEvent_OnJoinChannel);
	registerGlobalFunction("registerOnPlayerJoinChannel(Player player, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnJoinChannel);
	registerGlobalFunction("registerOnLeaveChannel(function callback)",
	                       &Manager::lua_registerGenericEvent_OnLeaveChannel);
	registerGlobalFunction("registerOnPlayerLeaveChannel(Player player, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnLeaveChannel);
	...
	registerGlobalFunction("registerOnPlayerLogout(Player player, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnLogout);

	// OnChangeOutfit
	registerGlobalFunction("registerOnChangeOutfit(function callback)",
	                       &Manager::lua_registerGenericEvent_OnChangeOutfit);
	registerGlobalFunction("registerOnPlayerChangeOutfit(Player player, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnChangeOutfit);

	// OnLook
	registerGlobalFunction("registerOnLookAtItem(string method, int filter, function callback)",
	                       &Manager::lua_registerGenericEvent_OnLookAtItem);
	registerGlobalFunction("registerOnLookAtCreature(Creature creature, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnLookAtCreature);
	registerGlobalFunction("registerOnPlayerLookAt(Creature creature, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnLook);

	// OnAdvance
	registerGlobalFunction("registerOnAdvance([LevelType skillid = nil], function callback)",
	                       &Manager::lua_registerGenericEvent_OnAdvance);
	registerGlobalFunction("registerOnPlayerAdvance(Player player [, LevelType "
	                       "skillid = nil], function callback)",
	                       &Manager::lua_registerSpecificEvent_OnAdvance);

	// OnShopPurchase/OnShopSell/OnShopClose
	registerGlobalFunction("registerOnShopPurchase(function callback)",
	                       &Manager::lua_registerGenericEvent_OnShopPurchase);
	registerGlobalFunction("registerOnShopSell(function callback)", &Manager::lua_registerGenericEvent_OnShopSell);
	registerGlobalFunction("registerOnShopClose(function callback)",
	                       &Manager::lua_registerGenericEvent_OnShopClose);

	// OnTradeBegin/onTradeEnd
	registerGlobalFunction("registerOnTradeBegin(string method [, int filter = "
	                       "nil], function callback)",
	                       &Manager::lua_registerGenericEvent_OnTradeBegin);
	registerGlobalFunction("registerOnPlayerTradeBegin(Player who, string method "
	                       "[, int filter = nil], function callback)",
	                       &Manager::lua_registerSpecificEvent_OnTradeBegin);
	registerGlobalFunction("registerOnTradeEnd(string method [, int filter = "
	                       "nil], function callback)",
	                       &Manager::lua_registerGenericEvent_OnTradeEnd);
	registerGlobalFunction("registerOnPlayerTradeEnd(Player who, string method "
	                       "[, int filter = nil], function callback)",
	                       &Manager::lua_registerSpecificEvent_OnTradeEnd);

	// OnCondition
	registerGlobalFunction("registerOnConditionEffect(string name, string "
	                       "method, function callback)",
	                       &Manager::lua_registerGenericEvent_OnConditionEffect);
	// registerGlobalFunction("registerOnCreatureConditionEffect(Creature
	// creature, string name, string method, function callback)",
	// &Manager::lua_registerSpecificEvent_OnConditionEffect);

	// OnAttack
	registerGlobalFunction(
	"registerOnAttack([string what = nil], string method, function callback)",
	&Manager::lua_registerGenericEvent_OnAttack);
	registerGlobalFunction("registerOnCreatureAttack(Creature creature, string "
	                       "method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnAttack);

	// OnDamage
	registerGlobalFunction(
	"registerOnDamage([mixed what = nil], string method, function callback)",
	&Manager::lua_registerGenericEvent_OnDamage);
	registerGlobalFunction("registerOnCreatureDamage(Creature creature [, mixed "
	                       "what = nil], string method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnDamage);

	// OnKill
	registerGlobalFunction(
	"registerOnKill([string what = nil], string method, function callback)",
	&Manager::lua_registerGenericEvent_OnKill);
	registerGlobalFunction("registerOnCreatureKill(Creature killer [, string "
	                       "what = nil], string method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnKill);
	registerGlobalFunction(
	"registerOnKilled([string what = nil], string method, function callback)",
	&Manager::lua_registerGenericEvent_OnKilled);
	registerGlobalFunction("registerOnCreatureKilled(Creature creature [, string "
	                       "what = nil], string method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnKilled);

	// OnDeath
	registerGlobalFunction("registerOnDeathBy([string what = nil], string "
	                       "method, function callback)",
	                       &Manager::lua_registerGenericEvent_OnDeathBy);
	registerGlobalFunction("registerOnCreatureDeathBy(Creature killer [, string "
	                       "what = nil], string method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnDeathBy);
	registerGlobalFunction(
	"registerOnDeath([string what = nil], string method, function callback)",
	&Manager::lua_registerGenericEvent_OnDeath);
	registerGlobalFunction("registerOnCreatureDeath(Creature creature [, string "
	                       "what = nil], string method, function callback)",
	                       &Manager::lua_registerSpecificEvent_OnDeath);

	// OnActorLoadSpell/OnActorCastSpell
	registerGlobalFunction("registerOnActorLoadSpell(function callback)",
	                       &Manager::lua_registerGenericEvent_OnActorLoadSpell);
	registerGlobalFunction("registerOnActorCastSpell(function callback)",
	                       &Manager::lua_registerGenericEvent_OnActorCastSpell);
	...
	registerGlobalFunction("canThrowObjectTo(position from, position to, boolean "
	                       "checkLineOfSight [, int rangex [,int rangey]])",
	                       &Manager::lua_canThrowObjectTo);
	...
	registerGlobalFunction("sendDistanceEffect([Creature c = nil], position "
	                       "from, position to, ShootEffect type)",
	                       &Manager::lua_sendDistanceEffect);
	registerGlobalFunction("sendAnimatedText(position where, int color, string text)",
	                       &Manager::lua_sendAnimatedText);
	...
	if (si_onsay.method == OnSay::FILTER_EXACT) {
		...
		if (environment->Generic.OnSay.empty()) {
			...
			for (ListenerList::iterator listener_iter = environment->Generic.OnSay.begin(),
				...
				OnSay::ScriptInformation info =
				boost::any_cast<OnSay::ScriptInformation>((*listener_iter)->getData());

				if (si_onsay.method == OnSay::FILTER_MATCH_BEGINNING) {
					// We should be inserted before substrings...
					if (info.method == OnSay::FILTER_SUBSTRING ||
					    info.method == OnSay::FILTER_ALL) {
			...
			if (!registered) environment->Generic.OnSay.push_back(listener);
		}
	}
	// Register event
	setRegistryItem(listener->getLuaTag());
...
int LuaState::lua_registerSpecificEvent_OnHear()
{
	...
	Listener_ptr listener(new Listener(ON_HEAR_LISTENER, p, *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerGenericEvent_OnUseWeapon()
{
	...
	case OnUseWeapon::FILTER_ITEMID:
		list = &environment->Generic.OnUseWeapon.ItemId[si_onuseweapon.id];
		break;
	case OnUseWeapon::FILTER_ACTIONID:
		list = &environment->Generic.OnUseWeapon.ActionId[si_onuseweapon.id];
		break;
	case OnUseWeapon::FILTER_FIST:
		list = &environment->Generic.OnUseFist;
		break;
	case OnUseWeapon::FILTER_ALL:
		list = &environment->Generic.OnUseAnyWeapon;
		break;
	default:
		break; // impossible, crash
	}
...
int LuaState::lua_registerSpecificEvent_OnLookAtCreature()
{
	...
	boost::any p(si_onlook);
	Listener_ptr listener(new Listener(ON_LOOKED_AT_LISTENER, p, *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerGenericEvent_OnSpawn()
{
	...
	boost::any p(0);
	Listener_ptr listener(new Listener(ON_SPAWN_LISTENER, p, *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerSpecificEvent_OnCreatureTurn()
{
	...
	Listener_ptr listener(new Listener(ON_TURN_LISTENER, boost::any(), *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerGenericEvent_OnMoveItem()
{
	...
	if (isItemOnTile) {
		...
		case OnMoveItem::FILTER_ITEMID:
			list = &environment->Generic.OnMoveItem.ItemId[id];
			break;
		case OnMoveItem::FILTER_ACTIONID:
			list = &environment->Generic.OnMoveItem.ActionId[id];
			break;
		default:
			break;
		}
...
int LuaState::lua_registerSpecificEvent_OnSpotCreature()
{
	...
	Listener_ptr listener(new Listener(ON_SPOT_CREATURE_LISTENER, boost::any(), *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerSpecificEvent_OnLoseCreature()
{
	...
	Listener_ptr listener(new Listener(ON_LOSE_CREATURE_LISTENER, boost::any(), *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
int LuaState::lua_registerSpecificEvent_OnCreatureThink()
{
	...
	Listener_ptr listener(new Listener(ON_THINK_LISTENER, boost::any(), *manager),
	                      boost::bind(&Listener::deactivate, _1));
...
{
	// Tied to a specific creature, and run each time that creature attacks
	// something
	// Store callback
	insert(-3);
...
{
	// Tied to damaged creature, either by name, damage type, creature type or all
	// damage
	// Store callback
	insert(-3);
...
{
	// Tied to a specific creature, and run each time that creature is taking
	// damage (or heals)
	// Store callback
	insert(-4);
...
{
	// Tied to a specific creature, and run each time that creature kills
	// something
	// Store callback
	insert(-4);
...
int LuaState::lua_Thing_getParentTile()
{
	...
	if (parent != NULL) {
		// Creatures are removed from the map, but parent pointer still remains on
		// tile
		// This should be fixed, but is a lot of work so this is a simpler solution
		// for now.
...
int LuaState::lua_Tile_getCreatures()
{
	...
	newTable();
	int n = 1;
	for (CreatureIterator it = tile->creatures_begin(), end_iter = tile->creatures_end();
	     it != end_iter; ++it, ++n) {
...
int LuaState::lua_Tile_getMoveableItems()
{
	...
	newTable();
	int n = 1;
	for (TileItemIterator iter = tile->items_begin(), end_iter = tile->items_end();
	     iter != end_iter; ++iter) {
		if ((*iter)->isMoveable()) {
			pushThing(*iter);
			setField(-2, n++);
...
{
	int32_t subtype = -1;
	if (getStackSize() > 2) subtype = popInteger();
...
int LuaState::lua_Tile_addItem()
{
	...
	ReturnValue ret = g_game.internalMoveItem(NULL, item->getParent(), tile, INDEX_WHEREEVER,
...
int LuaState::lua_Creature_addSummon()
{
	...
	if (summon == creature) throw Script::Error("A creature can not be a summon of itself.");
	if (creature != summon->getMaster()) {
		// Fix for being able to add summons belonging to a player already
		if (summon->isPlayerSummon()) summon->getMaster()->removeSummon(summon);
...
int LuaState::lua_Creature_getSummons()
{
	...
	int n = 1;
	for (std::list<Creature *>::const_iterator summon = summons.begin();
	     summon != summons.end(); ++summon, ++n) {
		pushThing(*summon);
		setField(-2, n);
	}
...
{
	bool force = false;
	if (getStackSize() > 2) force = popBoolean();
	...
	ReturnValue ret =
	g_game.internalMoveCreature(NULL, creature, ndir,
	                            force ? FLAG_IGNOREBLOCKITEM | FLAG_IGNOREBLOCKCREATURE : 0);
	pushBoolean(ret == RET_NOERROR);
	return 1;
}
...
template <class T> int Actor_modAttribute(LuaState *l, void (CreatureType::*mfp)(const T &))
{
...
#define Actor_getAttribute(mfp) push(popActor()->getType().mfp()), 1
...
{
	if (!isTable(-1)) {
		HandleError(Script::ERROR_THROW,
		            "Attempt to treat non-table value as an immunity-table.");
		pop();
		pushBoolean(false);
		return 1;
	}
...
int LuaState::lua_Actor_openShop()
{
	if (!isTable(-1)) {
		HandleError(Script::ERROR_THROW,
		            "Attempt to treat non-table value as a shop list.");
		pop();
		pushBoolean(false);
		return 1;
	}
...
int LuaState::lua_Player_hasGroupFlag()
{
	...
	Player *p = popPlayer();
	if (!f.exists()) throw Error("Invalid player flag passed to function Player.hasGroupFlag!");
...
int LuaState::lua_Player_internalWalkTo()
{
	...
	if (g_game.getPathTo(player, pos, listDir)) {
		...
		createTask(boost::bind(&Game::playerAutoWalk, &g_game, player->getID(), listDir)));
...
int LuaState::lua_Player_internalPickup()
{
	...
	ReturnValue ret = g_game.internalMoveItem(NULL, item->getParent(), player, INDEX_WHEREEVER,
	                                          item, item->getItemCount(), NULL);
...
int LuaState::lua_Player_addItem()
{
	...
	if (getStackSize() > 3) canDropOnMap = popBoolean();
	if (getStackSize() > 2) slot = popEnum<SlotType>();
	...
	ReturnValue ret = g_game.internalMoveItem(NULL, item->getParent(), player,
	                                          (slot == SLOT_WHEREEVER ? INDEX_WHEREEVER : slot.value()),
	                                          item, item->getItemCount(), NULL);
	if (ret != RET_NOERROR && canDropOnMap) {
		ret = g_game.internalMoveItem(NULL, item->getParent(), player->getParentTile(),
		                              INDEX_WHEREEVER, item, item->getItemCount(), NULL);
	}
...
int LuaState::lua_Player_removeItem()
{
	...
	int32_t count = 1;
	int32_t itemid = 0;
	if (getStackSize() > 3) count = popInteger();
	if (getStackSize() > 2) subtype = popInteger();
	itemid = popInteger();
	Player *player = popPlayer();
	...
	if (it.stackable && subtype != -1 && count == 1) count = subtype;
...
template <> inline void updateActionID<int32_t>(const std::string &key, Item *item, int32_t value)
{
	...
	if (key == "aid") item->setActionId(value);
}

template <typename T> int setItemAttribute(LuaState *state)
{
...
exposeItemAttribute(String, std::string) exposeItemAttribute(Integer, int32_t)
exposeItemAttribute(Float, float) exposeItemAttribute(Boolean, bool)
...
int LuaState::lua_Container_addItem()
{
	...
	ReturnValue ret = g_game.internalMoveItem(NULL, item->getParent(), container,
	                                          INDEX_WHEREEVER, item, item->getItemCount(), NULL,
	                                          FLAG_IGNOREBLOCKITEM | FLAG_IGNOREBLOCKCREATURE);
...
int LuaState::lua_Town_getHouse()
{
	...
	if (isNumber()) {
		...
		for (HouseMap::iterator it = houses->getHouseBegin(); it != houses->getHouseEnd(); ++it) {
			if (it->second->getName() == name) houseid = it->second->getHouseId();
		}
		if (houseid == 0)
			throw Script::Error("Town.getHouse : No house by the name '" + name +
			                    "' exists.");
	}
	Town *town = popTown();
	...
	if (house->getTownId() != town->getTownID())
		throw Script::Error("Town.getHouse : No house by the name '" + name +
		                    "' exists belongs to the town " + town->getName());
...
int LuaState::lua_House_getDoors()
{
	...
	newTable();
	int n = 1;
	for (HouseDoorList::iterator hit = house->getDoorBegin(), end = house->getDoorEnd(); hit != end; ++hit) {
		pushThing(*hit);
		setField(-2, n++);
	}
...
int LuaState::lua_House_getInvitedList()
{
	House *house = popHouse();
	std::string list;
	if (!house->getAccessList(GUEST_LIST, list)) pushNil();
...
int LuaState::lua_House_getSubownerList()
{
	House *house = popHouse();
	std::string list;
	if (!house->getAccessList(SUBOWNER_LIST, list)) pushNil();
	// Function is overloaded in lua to return table
	pushString(list);
	return 1;
}
...
int LuaState::lua_House_getTiles()
{
	...
	newTable();
	int n = 1;
	for (HouseTileList::iterator hit = house->getTileBegin(), end = house->getTileEnd(); hit != end; ++hit) {
		pushTile(*hit);
		setField(-2, n++);
	}
...
int LuaState::lua_Channel_getUsers()
{
	...
	newTable();
	int n = 1;
	for (UsersMap::const_iterator iter = channel->getUsers().begin();
	     iter != channel->getUsers().end(); ++iter) {
...
int LuaState::lua_saveGameState()
{
	...
	if (getStackSize() > 0) type = popEnum<ServerSaveType>();
...
int LuaState::lua_sendAnimatedText()
{
	...
	if (text.length() > 8)
		throw Error("Invalid value for parameter 'text': Animated text must be "
		            "less than 8 characters long.");
	if (color > 255)
		throw Error("Invalid value for parameter 'color': Color is an unsigned "
...
int LuaState::lua_rayCast()
{
	...
	if (getStackSize() > 2) checkFloor = popBoolean();
...
int LuaState::lua_canThrowObjectTo()
{
	...
	if (getStackSize() > 4) rangey = popInteger();
	if (getStackSize() > 3) rangex = popInteger();
