...
Item::Item(const uint16_t _id, uint16_t _count) : Thing(), ItemAttributes(), id(_id)
{
...
Item::Item(const Item& other) : Thing(), ItemAttributes(other), id(other.id), count(other.count)
{
}
