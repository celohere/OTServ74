...
PositionEx::PositionEx(const Position &p) : Position(p.x, p.y, p.z), stackpos(0)
{
}

PositionEx::PositionEx(const PositionEx &p) : Position(p.x, p.y, p.z), stackpos(p.stackpos)
{
}
