...
private:
	...
	void GetFloorDescription(NetworkMessage_ptr msg,
	                         int32_t x,
	                         int32_t y,
	                         int32_t z,
	                         int32_t width,
	...
	void AddMagicEffect(NetworkMessage_ptr msg, const Position &pos, MagicEffect type)
	{
		AddMagicEffect(msg, pos, type.value());
	}
...
#define addGameTaskTimed(delay, f, ...) \
	addGameTaskInternal(true, delay, boost::bind(f, &g_game, __VA_ARGS__))
