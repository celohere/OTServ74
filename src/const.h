...
{ FluidType(enums::FLUID_EMPTY), FluidType(enums::FLUID_WATER), FluidType(enums::FLUID_MANA),
  FluidType(enums::FLUID_BEER),  FluidType(enums::FLUID_EMPTY), FluidType(enums::FLUID_BLOOD),
  FluidType(enums::FLUID_SLIME), FluidType(enums::FLUID_EMPTY), FluidType(enums::FLUID_LEMONADE),
...
const ClientFluidType fluidMap[] = { enums::CLIENTFLUID_EMPTY, enums::CLIENTFLUID_BLUE,
	                             enums::CLIENTFLUID_RED,   enums::CLIENTFLUID_BROWN_1,
	                             enums::CLIENTFLUID_GREEN, enums::CLIENTFLUID_YELLOW,
	                             enums::CLIENTFLUID_WHITE, enums::CLIENTFLUID_PURPLE };
// end raw definitions
...
const int32_t violationNames[5] = { Action_None, Action_Namelock, Action_Namelock, Action_Namelock | Action_NamelockBan,
	                            Action_Namelock | Action_NamelockBan |
	                            Action_NamelockBanFinalWarning | Action_IpBan };

const int32_t violationStatements[5] = { Action_None, Action_None, Action_StatementReport,
	                                 Action_StatementReport | Action_Notation | Action_Banishment,
	                                 Action_StatementReport | Action_Notation |
	                                 Action_Banishment | Action_BanFinalWarning | Action_IpBan };
// end raw definitions
