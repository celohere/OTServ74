...
enum MessageClasses {
	...
	MSG_EVENT_DEFAULT =
	0x14, // White message at the bottom of the game window and in the console
	MSG_STATUS_DEFAULT =
	0x15, // White message at the bottom of the game window and in the console
...
const uint8_t reverseFluidMap[] = { FLUID_EMPTY,    FLUID_WATER, FLUID_MANAFLUID, FLUID_BEER,
	                            FLUID_EMPTY,    FLUID_BLOOD, FLUID_SLIME,     FLUID_EMPTY,
	                            FLUID_LEMONADE, FLUID_MILK };

const uint8_t fluidMap[] = { FLUID_EMPTY, FLUID_BLUE,  FLUID_RED,   FLUID_BROWN,  FLUID_EMPTY,
	                     FLUID_BLOOD, FLUID_GREEN, FLUID_EMPTY, FLUID_YELLOW, FLUID_WHITE };
...
enum Skulls_t { SKULL_NONE = 0, SKULL_YELLOW = 1, SKULL_GREEN = 2, SKULL_WHITE = 3, SKULL_RED = 4 };
